...
variable_interest_df <- expand.grid(as.character(variable_interest), as.character(variable_interest))
variable_interest_df <- subset(variable_interest_df, variable_interest_df$Var1 != variable_interest_df$Var2)
...
PC_Interest_Params <- data.frame(variable_interest_1 = as.character(variable_interest_df$Var1),
                                 variable_interest_2 = as.character(variable_interest_df$Var2),
...
FULL_MODEL_VALUE_INTEREST_PC <-  mcmapply(FULL_MODEL_SIMULATING_Duration_criss_cross_Two,
                                          c(PC_Interest_Params$variable_interest_1),
                                          c(PC_Interest_Params$variable_interest_2),
...
write.csv(FULL_MODEL_VALUE_INTEREST_PC_DT, file = "FULL_MODEL_VALUE_INTEREST_PC_YesdeathDT_TWO.csv")
...
PF_Interest_Params <- data.frame(variable_interest_1 = as.character(variable_interest_df$Var1),
                                  variable_interest_2 = as.character(variable_interest_df$Var2),
...
FULL_MODEL_VALUE_INTEREST_PF <-  mcmapply(FULL_MODEL_SIMULATING_Duration_criss_cross_Two,
                                          c(PF_Interest_Params$variable_interest_1),
                                          c(PF_Interest_Params$variable_interest_2),
...
write.csv(FULL_MODEL_VALUE_INTEREST_PF_DT, file = "FULL_MODEL_VALUE_INTEREST_PF_YesdeathDT_TWO.csv")
...
ALL_OPT_TWO <- rbind(PC_OPT, PF_OPT) 

write.csv(ALL_OPT ,here("Output","ALL_OPT_TWO.csv"))
